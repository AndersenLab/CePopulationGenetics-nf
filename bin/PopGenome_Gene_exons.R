...
# testing
# args <- c("III", "XZ1516", "Ce330_annotated.vcf.gz", "/projects/b1059/projects/Stefan/CePopulationGenetics-nf/input_files/Popgenome_files/WS245_exons.gff")
...
GENOME_OBJECT <- PopGenome::detail.stats(GENOME_OBJECT, subsites = 'exon')
